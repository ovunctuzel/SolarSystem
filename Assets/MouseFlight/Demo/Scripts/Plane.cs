...
namespace MFlight.Demo
{
    ...
    public class Plane : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                thrustMultiplier = 4.0f;
                screenShake.ToggleShake(true);
                pp.enabled = true;
            }
            else
            {
                thrustMultiplier = 1.0f;
                screenShake.ToggleShake(false);
                pp.enabled = false;
            }
        ...
        private void FixedUpdate()
        {
            ...
            rigid.AddRelativeForce(Vector3.forward * thrust * thrustMultiplier * forceMult, ForceMode.Force);
